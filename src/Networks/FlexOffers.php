...
use Padosoft\AffiliateNetwork\FlexOffersEx;
 ...
 */
class FlexOffers extends AbstractNetwork implements NetworkInterface
{
    /**
     * @var object
     */
    ...
    protected $_tracking_parameter    = 'fobs';

    /**
     * FlexOffers constructor.
    ...
    {
        $this->_network = new \Oara\Network\Publisher\FlexOffers;
    ...
    public function getSales(\DateTime $dateFrom, \DateTime $dateTo, array $arrMerchantID = array()) : array
    {
        ...
        foreach($transactionList as $transaction) {
            ...
            $Transaction->date = new \DateTime($date); // $date->format('Y-m-d H:i:s');
