 ...
 */
class WebePartnersV2 extends AbstractNetwork implements NetworkInterface
{
    /**
     * @var object
     */
    ...
    protected $_tracking_parameter    = 'p1';

    /**
     * WebePartnersV2 constructor.
    ...
    {
        $this->_network = new \Oara\Network\Publisher\WebePartnersV2;
