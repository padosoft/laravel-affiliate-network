 ...
 */
class Inis extends AbstractNetwork implements NetworkInterface
{
    /**
     * @var object
     */
    ...
    {
        $this->_network = new \Oara\Network\Publisher\Inis;
    ...
    public function getSales(\DateTime $dateFrom, \DateTime $dateTo, array $arrMerchantID = array()) : array
    {
        ...
        foreach($transactionList as $transaction) {
            ...
            if (isset($transaction['amount']) && !empty($transaction['amount'])) {
