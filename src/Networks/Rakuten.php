 ...
 */
class Rakuten extends AbstractNetwork implements NetworkInterface
{
    /**
     * @var object
     */
    ...
    protected $_tracking_parameter    = 'u1';
    private $_idSite = '';
    ...
    {
        $this->_network = new \Oara\Network\Publisher\Rakuten();
    ...
    public function getDeals($merchantID=NULL,int $page=0,int $items_per_page=10 ): DealsResultset
    {
        ...
        $network = $_ENV['RAKUTEN_NETWORK'];
        $result = DealsResultset::createInstance();

        $arrVouchers = $this->_network->getVouchers($network);
    ...
    public function getSales(\DateTime $dateFrom, \DateTime $dateTo, array $arrMerchantID = array()) : array
    {
        ...
        $arrResult = array();
        $this->_network->_nid = $_ENV['RAKUTEN_NETWORK'];
